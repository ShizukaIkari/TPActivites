 ...
 *
 * Instruções para execução: No terminal, na pasta bin, executar: java -cp ./
 * ifes.bsi.tpa.grafo.GrafBenchmark
 *
 * Para visualizar o grafo com GraphStream, desabilitar os comentários que
 * ativam a exibição. Os comentários estão no final do método main. Uma vez
 * desabilitados, use a seguinte linha de chamada no console: java -cp
 * ./:../../../GraphStream1.3/gs-core-1.3/gs-core-1.3.jar:../../../GraphStream1.3/gs-ui-1.3/gs-ui-1.3.jar
 * ifes.bsi.tpa.grafo.GrafBenchmark
 *
 * Substitua ../../.. pelo caminho até a pasta GraphStream (a artir de bin) no
 * seu computador.
 *
 */
