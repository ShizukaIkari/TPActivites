...
public class ProcessaGrafo {
    ...
    public LinkedList<Vertex> bfs(String vLabel) {
        ...
        while(!fila.isEmpty()) {
            ...
            LinkedList<Vertex> vizinhos = graph.outAdjacentVertices(head.getLabel());
    ...
    public LinkedList<Vertex> dfs(String vLabel) {
        ...
        while (!pVisitados.isEmpty()) {
            ...
            LinkedList<Vertex> vizinhos = graph.outAdjacentVertices(topoPilha.getLabel());
